...
You can build the client and server with the 'make' command.  Launch server with _'./server portnumber'_ and you launch client with _'./client serverip serverport'_.
